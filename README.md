...
## 🖼️ Скриншоты результатов

Ниже — несколько скриншотов, демонстрирующих работу загрузки документов, индексирования и выдачи результатов поиска/чата. Изображения добавлены в папку `docs/`.

![Результат поиска — пример фрагмента](docs/screen1.png)
*Описание: пример ответа чата с выделенными фрагментами из проиндексированного документа.*

![Загрузка документа и подтверждение индексирования](docs/screen2.png)
*Описание: процесс загрузки документа через API и сообщение об успешной индексации.*

![Интерфейс результатов поиска](docs/screen3.png)
*Описание: просмотр найденных фрагментов и предоставленного контекста для LLM.*

![Логи и демонстрация RAG-ответа](docs/screen4.png)
*Описание: пример генерации итогового ответа на основе найденных фрагментов (RAG-пайплайн).*
